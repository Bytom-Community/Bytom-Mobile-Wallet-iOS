  ...
  struct storyboard: Rswift.Validatable {
    ...
    struct me: Rswift.StoryboardResourceWithInitialControllerType, Rswift.Validatable {
      ...
      func iconVC(_: Void = ()) -> IconVC? {
        return UIKit.UIStoryboard(resource: self).instantiateViewController(withResource: iconVC)
      }
      ...
      func recordVC(_: Void = ()) -> RecordVC? {
        return UIKit.UIStoryboard(resource: self).instantiateViewController(withResource: recordVC)
      }
      
      static func validate() throws {
        if UIKit.UIImage(named: "node") == nil { throw Rswift.ValidationError(description: "[R.swift] Image named 'node' is used in storyboard 'Me', but couldn't be loaded.") }
        if UIKit.UIImage(named: "transfer_in") == nil { throw Rswift.ValidationError(description: "[R.swift] Image named 'transfer_in' is used in storyboard 'Me', but couldn't be loaded.") }
        if UIKit.UIImage(named: "share") == nil { throw Rswift.ValidationError(description: "[R.swift] Image named 'share' is used in storyboard 'Me', but couldn't be loaded.") }
        if UIKit.UIImage(named: "info") == nil { throw Rswift.ValidationError(description: "[R.swift] Image named 'info' is used in storyboard 'Me', but couldn't be loaded.") }
    ...
    struct wallet: Rswift.StoryboardResourceWithInitialControllerType, Rswift.Validatable {
      ...
      let transferVC = StoryboardViewControllerResource<TransferVC>(identifier: "TransferVC")
      ...
      func transferVC(_: Void = ()) -> TransferVC? {
        return UIKit.UIStoryboard(resource: self).instantiateViewController(withResource: transferVC)
      }
      ...
      static func validate() throws {
        ...
        if UIKit.UIImage(named: "round") == nil { throw Rswift.ValidationError(description: "[R.swift] Image named 'round' is used in storyboard 'Wallet', but couldn't be loaded.") }
        ...
        if UIKit.UIImage(named: "round_select") == nil { throw Rswift.ValidationError(description: "[R.swift] Image named 'round_select' is used in storyboard 'Wallet', but couldn't be loaded.") }
        ...
        if _R.storyboard.wallet().transferVC() == nil { throw Rswift.ValidationError(description:"[R.swift] ViewController with identifier 'transferVC' could not be loaded from storyboard 'Wallet' as 'TransferVC'.") }
