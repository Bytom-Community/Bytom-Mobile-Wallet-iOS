...
class MeMenuCell: FormBaseCell {
    ...
    open override func constraintsViews() -> [String : UIView] {
        ...
        var views = ["titleLabel" : titleLabel, "imageView" : imageView, "valueLabel" : valueLabel]
        if self.imageView!.image != nil {
            views["imageView"] = imageView
        }
        return views as! [String : UIView]
    }
    ...
    open override func defaultVisualConstraints() -> [String] {
        ...
        if self.imageView!.image != nil {
            if let text = titleLabel.text , text.count > 0 {
                return ["H:[imageView]-15-[titleLabel]-[valueLabel]-\(rightPadding)-|"]
            } else {
                return ["H:[imageView]-15-[titleLabel]-[valueLabel]-\(rightPadding)-|"]
            }
        } else {
